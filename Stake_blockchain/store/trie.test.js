 ...
 */
  ...
  */
   ...
   */
   describe('Trie', () => {
     // Establish trie var for use in tests
     let trie;
     // Before each test create a new trie Object
     beforeEach(() => {
       trie = new Trie();
     });

    it('has a rootHash', () => {
      expect(trie.rootHash).not.toBeUndefined();
    });
    ...
    describe('put()', () => {
      ...
      it('generates a new rootHash after entering the value', () => {
