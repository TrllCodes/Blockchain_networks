...
describe('Block', () => {
  ...
  describe('mineBlock()', () => { //When there are multiple tests that can share the same setup, it is often uselful to declare variables that are shared across those tests at the top of the describe block.
    let lastBlock, minedBlock;

    beforeEach(() => { //runs before every subsequent "it" block in the code block.
